...
const OurJourney = () => {
  ...
  return (
    <Layout pageTitle="Mission 500 | About">
      ...
      <div style={{ maxWidth: "1300px" }} className="container mt-5">
        <div className="row">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex justify-content-between">
                    <h5 className="card-title">{milestone.name}</h5>
                    <p
                      onClick={() => {
                        setMilestone({});
                  ...
                  <p className="card-text">{milestone.content}</p>
                </div>
              </div>
            )}
          </div>
          <div className="col-md-5">
            <Image
              ...
              width={800}
              height={500}
              className="border border-4 img-fluid"
            />
          </div>
        </div>
